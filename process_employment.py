...
Columns:
ID    night_shifts_worked consecutive_night_shifts_during_mixed_shifts consecutive_night_shifts_during_night_sihfts day_shifts_worked job_involved_shift_work mixture_of_day_and_night_shifts night_shifts_worked number_night_shifts_monthly_during_mixed_shifts number_night_shifts_monthly_during_night_shifts period_spent_working_day_shifts period_spent_working_mixed_shifts period_spent_working_night_shifts rest_days_during_mixed_shift_periods rest_days_during_night_shift_periods length_of_night_shift_during_mixed_shifts length_of_night_shift_during_night_shifts year_job_ended year_job_start
