...
pylab.savefig("../processed/mental_health/mental_health_correlations.svg")
plot_corr(activity, activity, "Activity Correlations")
pylab.savefig("../processed/mental_health/activity_correlations.svg")
plot_corr(mental_health, activity, "Activity - Mental Health Correlations")
pylab.savefig("../processed/mental_health/activity_mental_health_correlation.svg")
...
pylab.savefig("../processed/mental_health/mental_health_corr_with_top_cca.svg")
plot_corr(activity_scores, activity, "Activity Variable Correlations with Canonical Components")
pylab.savefig("../processed/mental_health/activity_corr_with_top_cca.svg")
